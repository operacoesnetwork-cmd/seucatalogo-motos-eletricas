...
export default function RegisterPage() {
  return (
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden bg-neutral-950">
      ...
      <div className="w-full max-w-[420px] relative z-10 px-6 my-8">
        {/* Back link */}
        <Link
          href="/"
        ...
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 p-8 md:p-10 rounded-[2rem] shadow-2xl relative overflow-hidden">
          {/* Inner Glow */}
          <div className="absolute top-0 left-0 w-64 h-64 bg-primary/10 blur-[80px] -translate-y-1/2 -translate-x-1/2 rounded-full pointer-events-none" />
          ...
          <div className="relative z-10">
            ...
            <div className="text-center mb-8">
              ...
              <h1 className="text-2xl md:text-3xl font-bold text-white mb-2 tracking-tight">Criar nova conta</h1>
              <p className="text-gray-400 text-sm md:text-base">Monte seu catálogo digital em minutos</p>
            </div>
            ...
            <div className="mt-8 text-center pt-6 border-t border-white/5">
              <p className="text-sm text-gray-500">
                Já tem uma conta?{" "}
                <Link href="/login" className="text-primary hover:text-primary-300 font-medium transition-colors hover:underline underline-offset-4">
                  Fazer login
                </Link>
              </p>
            </div>
